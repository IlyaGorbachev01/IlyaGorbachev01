...
- **Языки:** `Python 3.9+`
- **Фреймворки & Библиотеки:** `Django` `Django REST Framework` `FastAPI`
- **Базы данных:** `PostgreSQL` `MS SQL Server` `SQLite`
- **DevOps & Инструменты:** `Docker` `Docker Compose` `Git` `GitHub Actions` `CI/CD`
- **Тестирование & QA:** `pytest`
